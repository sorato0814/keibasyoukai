...
ActiveRecord::Schema.define(version: 2024_03_03_093356) do
  ...
  create_table "horse_tag_relations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["horse_id"], name: "index_horse_tag_relations_on_horse_id"
    t.index ["tag_id"], name: "index_horse_tag_relations_on_tag_id"
  end
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
    t.index ["horse_id"], name: "index_likes_on_horse_id"
  end
